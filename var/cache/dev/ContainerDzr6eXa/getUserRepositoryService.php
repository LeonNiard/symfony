...
{
    /**
     * Gets the private 'App\Customers\Domain\Repository\UserRepository' shared autowired service.
     *
     * @return \App\Customers\Domain\Repository\UserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Customers/Domain/Repository/UserRepository.php';

        return $container->privates['App\\Customers\\Domain\\Repository\\UserRepository'] = new \App\Customers\Domain\Repository\UserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
