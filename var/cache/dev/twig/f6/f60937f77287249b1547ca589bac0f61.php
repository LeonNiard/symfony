...
class __TwigTemplate_00a8b49b78e3da995d235990ea515ebf extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["album"]) {
            ...
            if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ARTIST")) {
                ...
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_album_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["album"], "id", [], "any", false, false, false, 18)]), "html", null, true);
                echo "\">edit</a></div>
            ";
            }
            // line 20
            echo "            <div class=\"p-3 w-12 flex-shrink-0 text-right\"><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_album_show", ["id" => twig_get_attribute($this->env, $this->source, $context["album"], "id", [], "any", false, false, false, 20)]), "html", null, true);
            echo "\">view</a></div>
        </div>
    ";
...
";
    ...
    {
        return array (  103 => 31,  101 => 30,  96 => 27,  87 => 23,  78 => 20,  72 => 18,  70 => 17,  65 => 15,  60 => 12,  55 => 11,  43 => 1,);
    }
